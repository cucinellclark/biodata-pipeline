...
#data_dir = "/lus/eagle/projects/argonne_tpc/chia-llama2/RAG-evaluation/data_modelseed"
#data_dir = "/home/cc8dm/RAG-eval/GeneratedData/mixtral_gen1"
data_dir = "/home/cc8dm/RAG-eval/BiodataTestingRubric/bv-brc/parsed_genome_data"
output_dir = "/lus/eagle/projects/argonne_tpc/cucinell/BiodataTestingRubric/json_tests/pathway_adapters/"
model_name = "/lus/eagle/projects/argonne_tpc/chia-llama2/autotrain/Llama-2-7b-chat-hf"
#model_name = "/home/cc8dm/RAG-eval/mistral"
training_data = "pathway.json"
#epoch_list = list(range(25,1025,25))
#epoch_list = list(range(10,1025,10))
#epoch_list = list(range(25,425,25))
epoch_list = list(range(20,420,20))
epoch_list = [str(x/100) for x in epoch_list]
adapter_prefix = "/lus/eagle/projects/argonne_tpc/cucinell/BiodataTestingRubric/json_tests/genome_feature_adapters/TMP_RESULTS_Llama-2-7b-chat-hf_"
